...
# Channel maps
def channelmaps(self, f_conti=None, grid=None, data=None, outname=None, outformat='pdf',
    imscale=[], color=False, cbaron=False, cmap='Blues', vmin=None, vmax=None,
    contour=True, clevels=[], ccolor='k', conti_rms=[], clevels_conti=[],
    nrow=5, ncol=5, velmin=None, velmax=None, nskip=1, clw=0.5, color_norm=None,
    xticks=[], yticks=[], relativecoords=True, vsys=None, csize=14, family = 'times', scalebar=np.empty(0),
    ...
    # properties of plots
    #mpl.use('Agg')
    plt.rcParams['font.family']     = family # font (Times New Roman, Helvetica, Arial)
    plt.rcParams['xtick.direction'] = 'in'   # directions of x ticks ('in'), ('out') or ('inout')
    plt.rcParams['ytick.direction'] = 'in'   # directions of y ticks ('in'), ('out') or ('inout')
    plt.rcParams['font.size']       = csize  # fontsize
    ...
    # continuum map in contour
    rms_conti      = conti_rms   # Jy/beam
    clevels_conti  = clevels_conti # contour levels

    im_conti = Imfits(f_conti)
    data_conti = im_conti.data[0,0,:,:]
    ...
    for ichan in range(nv_plt):
        ...
        if contour:
            imcont = ax.contour(Sv, colors=ccolor, origin='lower',extent=extent, levels=clevels, linewidths=clw, linestyles = 'dashed')
            imcont = ax.contour(data_conti,colors='k', origin='lower', extent=extent, levels=clevels_conti, linewidths=clw)
...
def N2Dp_channelmaps(self, f_conti=None, grid=None, data=None, outname=None, outformat='pdf',
    imscale=[], color=False, cbaron=False, cmap='Blues', vmin=None, vmax=None,
    contour=True, clevels=[], ccolor='k', conti_rms=[], clevels_conti=[],
    nrow=5, ncol=5, velmin=None, velmax=None, nskip=1, clw=0.5, color_norm=None,
    xticks=[], yticks=[], relativecoords=True, vsys=None, csize=14, family = 'times', scalebar=np.empty(0),
...
def C18O_channelmaps(self, f_conti=None, grid=None, data=None, outname=None, outformat='pdf',
    imscale=[], color=False, cbaron=False, cmap='Blues', vmin=None, vmax=None,
    contour=True, clevels=[], ccolor='k', conti_rms=[], clevels_conti=[],
    nrow=5, ncol=5, velmin=None, velmax=None, nskip=1, clw=0.5, color_norm=None,
    xticks=[], yticks=[], relativecoords=True, vsys=None, csize=14, family = 'times', scalebar=np.empty(0),
