...
Msun   = 1.988e33               # solar mass [g]
Lsun   = 3.85e33        # solar total luminosity [erg/s]
Rsun   = 6.960e10                 # solar radius [cm]
Tsun   = 5778                        # solar temperature [K]
pi     = np.pi
mH     = 1.672621898e-24 # proton mass [g]
mu     = 2.3 #mean_molecular_mass
Mearth = 3.0404e-6*Msun  # Earth mass [g]
Mjup   = 9.5479e-4*Msun    # Jupiter mass [g]
Msaturn = 2.8589e-4*Msun
Mneptune = 5.1514e-5*Msun   # Neptune  mass [g]
# distance
# AU --> km 1.50e8
# AU --> cm 1.50e13
